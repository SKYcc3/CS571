...
function calculateSalesTax() {
	...
	let tex = calculateSubtotal() * getSalesTaxRateForState(state);
	return tex; // TODO calculateSalesTax
}
...
document.getElementById("btn-checkout").addEventListener("click", () => {
	let bill = calculateSalesTax() + calculateSubtotal();
	alert("Your total bill is: $" + parseFloat(bill).toFixed(2));
});
